...
namespace iSukces.Mathematics
{
    public sealed class LineEquation : ICloneable
    {
        ...
        public static ThePoint? Cross([NotNull] LineEquation p1, [NotNull] LineEquation p2)
        {
        ...
        public static ThePoint? CrossLineSegment(ThePoint p1Begin, ThePoint p1End, ThePoint p2Begin, ThePoint p2End)
        {
            ...
            if (crossPointNullable == null) return null;
        ...
        public static explicit operator LineEquation([NotNull]LinearFunc a)
        {
            return new LineEquation(a.A, -1, a.B);
        }


        public static LineEquation operator -([NotNull]LineEquation a)
        {
        ...
        public ThePoint? Cross([NotNull] LineEquation other)
        {
