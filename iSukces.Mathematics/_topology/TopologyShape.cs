...
namespace iSukces.Mathematics
{
    public sealed class TopologyShape : TopologyBase
    {
        ...
        {
            if (PointRound >= 0) p = new Point(System.Math.Round(p.X, PointRound), System.Math.Round(p.Y, PointRound));
        ...
        {
            if (cutter == null || cutter.Triangles == null || cutter.Triangles.Count == 0) return this;
            var from = this;
